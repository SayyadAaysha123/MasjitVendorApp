...
class WeeklyNamazTiming extends StatefulWidget {
  const WeeklyNamazTiming({Key? key}) : super(key: key);

  @override
  State<WeeklyNamazTiming> createState() => _WeeklyNamazTimingState();
}

class _WeeklyNamazTimingState extends State<WeeklyNamazTiming> with SingleTickerProviderStateMixin  {
