...
class EidTiming extends StatefulWidget {
  const EidTiming({Key? key}) : super(key: key);

  @override
  State<EidTiming> createState() => _EidTimingState();
}

class _EidTimingState extends State<EidTiming>
  ...
  Widget getAddtimePiker(double parentHeight, double parentWidth) {
    return Container(
      padding: EdgeInsets.only(top: parentHeight * 0.08),
      child: Column(
        children: <Widget>[
          hourMinute12H(),
  ...
  Widget getTodayDate(double parentHeight, double parentWidth) {
    return Stack(
      ...
      children: [
        Padding(
          padding: EdgeInsets.only(
              left: parentWidth * 0.0, top: parentHeight * 0.05),
          child: ClipRRect(
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                gradient: LinearGradient(
                    ...
                    colors: [
                      CommonColor.REGISTRARTION_COLOR,
                      CommonColor.REGISTRARTION_COLOR
                    ]),
              ),
              child: Column(
                children: [
                  Row(
                    ...
                    children: [
                      Padding(
                        padding: EdgeInsets.only(
                            left: parentWidth * 0.04, top: parentWidth * 0.03),
                        child: Text(
                          "Todays Date",
                          style: TextStyle(
                              fontFamily: "Roboto_Regular",
        ...
        Padding(
          ...
          child: ClipRRect(
            ...
            child: Container(
              height: parentHeight * 0.1,
              decoration: const BoxDecoration(color: CommonColor.WHITE_COLOR),
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  GestureDetector(
